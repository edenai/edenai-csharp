...
${nuget_cmd} install src/EdenAI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/EdenAI.dll"
...
then
  ...
  echo "[INFO] bin/EdenAI.dll was created successfully"
fi
