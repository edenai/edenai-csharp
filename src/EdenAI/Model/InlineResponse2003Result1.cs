...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2003Result1 :  IEquatable<InlineResponse2003Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2003Result1" /> class.
        /// </summary>
        ...
        public InlineResponse2003Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), InlineResponse2003Result result = default(InlineResponse2003Result))
        {
        ...
        public InlineResponse2003Result Result { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2003Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse2003Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2003Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2003Result1 input)
        {
            if (input == null)
                return false;
