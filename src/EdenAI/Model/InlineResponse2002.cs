...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(List<InlineResponse2002Result1> result = default(List<InlineResponse2002Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2002Result1> Result { get; set; }
