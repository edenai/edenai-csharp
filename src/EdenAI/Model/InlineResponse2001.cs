...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(List<InlineResponse2001Result1> result = default(List<InlineResponse2001Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2001Result1> Result { get; set; }
