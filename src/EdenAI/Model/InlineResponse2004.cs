...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(List<InlineResponse2004Result1> result = default(List<InlineResponse2004Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2004Result1> Result { get; set; }
