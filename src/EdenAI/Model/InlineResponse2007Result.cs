...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007Result :  IEquatable<InlineResponse2007Result>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2007Result" /> class.
        /// </summary>
        ...
        public InlineResponse2007Result(string sourceLanguage = default(string), string targetLanguage = default(string), string translatedText = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name="translated_text", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as InlineResponse2007Result);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Result instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Result to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Result input)
        {
            if (input == null)
                return false;
