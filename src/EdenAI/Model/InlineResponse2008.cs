...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(List<InlineResponse2008Result1> result = default(List<InlineResponse2008Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2008Result1> Result { get; set; }
