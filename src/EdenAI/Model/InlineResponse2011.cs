...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2011 :  IEquatable<InlineResponse2011>, IValidatableObject
    {
        ...
        public InlineResponse2011(List<InlineResponse2011Result1> result = default(List<InlineResponse2011Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2011Result1> Result { get; set; }
