...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(List<InlineResponse2007Result1> result = default(List<InlineResponse2007Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2007Result1> Result { get; set; }
