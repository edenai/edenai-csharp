...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2002MerchantInformation :  IEquatable<InlineResponse2002MerchantInformation>, IValidatableObject
    {
        ...
        public InlineResponse2002MerchantInformation(string merchantAddress = default(string), string merchantName = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name="merchant_address", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as InlineResponse2002MerchantInformation);
        }

        /// <summary>
        /// Returns true if InlineResponse2002MerchantInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002MerchantInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002MerchantInformation input)
        {
            if (input == null)
                return false;
