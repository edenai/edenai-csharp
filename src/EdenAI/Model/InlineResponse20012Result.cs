...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20012Result :  IEquatable<InlineResponse20012Result>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20012Result" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="executionTime">executionTime.</param>
        /// <param name="result">object.</param>
        public InlineResponse20012Result(string status = default(string), decimal? executionTime = default(decimal?), Object result = default(Object))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as InlineResponse20012Result);
        }

        /// <summary>
        /// Returns true if InlineResponse20012Result instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20012Result to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20012Result input)
        {
            if (input == null)
                return false;
