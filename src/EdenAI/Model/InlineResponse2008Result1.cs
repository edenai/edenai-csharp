...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2008Result1 :  IEquatable<InlineResponse2008Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008Result1" /> class.
        /// </summary>
        ...
        public InlineResponse2008Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), InlineResponse2008Result result = default(InlineResponse2008Result))
        {
        ...
        public InlineResponse2008Result Result { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse2008Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse2008Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008Result1 input)
        {
            if (input == null)
                return false;
