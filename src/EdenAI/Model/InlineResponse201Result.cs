...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse201Result :  IEquatable<InlineResponse201Result>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse201Result" /> class.
        /// </summary>
        /// <param name="transcribe">transcribe.</param>
        /// <param name="confidence">confidence.</param>
        public InlineResponse201Result(string transcribe = default(string), decimal? confidence = default(decimal?))
        {
        ...
        {
            return this.Equals(input as InlineResponse201Result);
        }

        /// <summary>
        /// Returns true if InlineResponse201Result instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse201Result to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse201Result input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Transcribe == input.Transcribe ||
                    (this.Transcribe != null &&
                    this.Transcribe.Equals(input.Transcribe))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Transcribe != null)
                    hashCode = hashCode * 59 + this.Transcribe.GetHashCode();
