...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(List<InlineResponse2006Result1> result = default(List<InlineResponse2006Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2006Result1> Result { get; set; }
