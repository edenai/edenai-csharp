...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2002Result1 :  IEquatable<InlineResponse2002Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2002Result1" /> class.
        /// </summary>
        ...
        public InlineResponse2002Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), List<InlineResponse2002Result> result = default(List<InlineResponse2002Result>))
        {
        ...
        public List<InlineResponse2002Result> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2002Result1 {\n");
        ...
        {
            return this.Equals(input as InlineResponse2002Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse2002Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2002Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2002Result1 input)
        {
            if (input == null)
                return false;
