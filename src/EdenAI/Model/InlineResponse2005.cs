...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(List<InlineResponse2005Result1> result = default(List<InlineResponse2005Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2005Result1> Result { get; set; }
