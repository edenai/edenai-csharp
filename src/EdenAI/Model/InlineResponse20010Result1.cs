...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20010Result1 :  IEquatable<InlineResponse20010Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20010Result1" /> class.
        /// </summary>
        ...
        public InlineResponse20010Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), InlineResponse20010Result result = default(InlineResponse20010Result))
        {
        ...
        {
            return this.Equals(input as InlineResponse20010Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse20010Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20010Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20010Result1 input)
        {
            if (input == null)
                return false;
