...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2008Result :  IEquatable<InlineResponse2008Result>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2008Result" /> class.
        /// </summary>
        /// <param name="text">text.</param>
        /// <param name="languages">languages.</param>
        /// <param name="confidences">confidences.</param>
        public InlineResponse2008Result(string text = default(string), List<string> languages = default(List<string>), List<decimal?> confidences = default(List<decimal?>))
        {
            this.Text = text;
        ...
        {
            return this.Equals(input as InlineResponse2008Result);
        }

        /// <summary>
        /// Returns true if InlineResponse2008Result instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2008Result to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2008Result input)
        {
            if (input == null)
                return false;
