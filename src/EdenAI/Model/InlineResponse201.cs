...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse201 :  IEquatable<InlineResponse201>, IValidatableObject
    {
        ...
        public InlineResponse201(List<InlineResponse201Result1> result = default(List<InlineResponse201Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse201Result1> Result { get; set; }
