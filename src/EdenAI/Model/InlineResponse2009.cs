...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(List<InlineResponse2009Result1> result = default(List<InlineResponse2009Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2009Result1> Result { get; set; }
