...
namespace EdenAI.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<InlineResponse2003Result1> result = default(List<InlineResponse2003Result1>))
        {
            this.Result = result;
        }
        ...
        public List<InlineResponse2003Result1> Result { get; set; }
