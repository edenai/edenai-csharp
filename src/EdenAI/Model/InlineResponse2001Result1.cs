...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2001Result1 :  IEquatable<InlineResponse2001Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2001Result1" /> class.
        /// </summary>
        ...
        public InlineResponse2001Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), InlineResponse2001Result result = default(InlineResponse2001Result))
        {
        ...
        public InlineResponse2001Result Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2001Result1 {\n");
        ...
        {
            return this.Equals(input as InlineResponse2001Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse2001Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2001Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2001Result1 input)
        {
            if (input == null)
                return false;
