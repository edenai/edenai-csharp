...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004Result1 :  IEquatable<InlineResponse2004Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004Result1" /> class.
        /// </summary>
        ...
        public InlineResponse2004Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), InlineResponse2004Result result = default(InlineResponse2004Result))
        {
        ...
        {
            return this.Equals(input as InlineResponse2004Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse2004Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004Result1 input)
        {
            if (input == null)
                return false;
