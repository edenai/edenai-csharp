...
namespace EdenAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse20011Result1 :  IEquatable<InlineResponse20011Result1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20011Result1" /> class.
        /// </summary>
        ...
        public InlineResponse20011Result1(string solutionName = default(string), string provider = default(string), string status = default(string), decimal? executionTime = default(decimal?), Object originalResult = default(Object), InlineResponse20011Result result = default(InlineResponse20011Result))
        {
        ...
        public InlineResponse20011Result Result { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse20011Result1);
        }

        /// <summary>
        /// Returns true if InlineResponse20011Result1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20011Result1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20011Result1 input)
        {
            if (input == null)
                return false;
